...
// .svelte-kit/adapter-node/entries/pages/(app)/product/_slug_/_page.svelte.js
...
var Radio = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  createEventDispatcher();
...
var DeliveryOptions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var SimilarProducts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var FrequentlyBoughtProduct = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  var _a, _b;
  let $$unsubscribe_page;
  $$unsubscribe_page = subscribe(page, (value) => value);
  let { product = {} } = $$props;
...
//# sourceMappingURL=_page.svelte-DN7D6EAJ.js.map
