...
// .svelte-kit/adapter-node/chunks/PrimaryButton.js
var css = {
...
var PrimaryButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  createEventDispatcher();
  let { loading = false, loadingringsize = "base", disabled = false, roundedNone = false, roundedFull = false, hideLoading = false, clickEffect = false, type = "button" } = $$props;
...
//# sourceMappingURL=chunk-LMH4TTMN.js.map
