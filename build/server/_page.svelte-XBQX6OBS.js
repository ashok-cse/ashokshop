...
// .svelte-kit/adapter-node/entries/pages/(app)/my/reviews/_page.svelte.js
var import_dayjs = __toESM(require_dayjs_min(), 1);
var import_hash_it = __toESM(require_hash_it_cjs(), 1);
import "vanilla-lazyload";
import "cookie-universal";
var time = readable(new Date().getTime(), function start(set) {
...
var TimeAgo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let asDate;
  let diff;
  let seconds;
  let minutes;
...
//# sourceMappingURL=_page.svelte-XBQX6OBS.js.map
