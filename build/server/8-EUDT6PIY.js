...
// .svelte-kit/adapter-node/entries/pages/(app)/_slug_/_page.server.ts.js
...
var prerender = false;
async function load({ url, params, setHeaders, parent }) {
  const { store } = await parent();
  let loading = false, err, count, products, facets, ressss, fl = {}, category;
...
//# sourceMappingURL=8-EUDT6PIY.js.map
