...
// .svelte-kit/adapter-node/chunks/MobileFilter.js
var css$1 = {
...
var CheckboxEs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let filteredTerms;
  createEventDispatcher();
...
var DesktopFilter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var MobileFilter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_page;
  $$unsubscribe_page = subscribe(page, (value) => value);
  createEventDispatcher();
  let { class: clazz = "" } = $$props;
...
//# sourceMappingURL=chunk-66CC5YUB.js.map
