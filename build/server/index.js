...
var require_devalue_umd = __commonJS({
  "node_modules/devalue/dist/devalue.umd.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.devalue = factory();
    })(exports, function() {
      "use strict";
      ...
      return `${components[2] ? `${validate_component(components[1] || missing_component, "svelte:component").$$render($$result, { data: data_1, errors }, {}, {
        default: () => {
          return `${components[3] ? `${validate_component(components[2] || missing_component, "svelte:component").$$render($$result, { data: data_2, errors }, {}, {
            default: () => {
              return `${validate_component(components[3] || missing_component, "svelte:component").$$render($$result, { data: data_3 }, {}, {})}`;
            }
...
var Server = class {
  ...
  async init({ env }) {
    ...
    if (!this.options.hooks) {
      const module = await import("./index7-NXQQJEL2.js");
      this.options.hooks = {
